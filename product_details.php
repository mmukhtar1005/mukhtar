...
<head>
  ...
  <title>The Alam Sweets and Restaurant Shop </title>
  <meta name="description" content="The Alam Sweets and restaurant  shop is an online sweet shop established in 1995 in Sirsi, Sambhal, Moradabad, Uttar Pradesh. It is the only online sweet shop in the town.">
...
<body>
  ...
  <section id="banner">
    <div class="bg-color">
      <header id="header">
        <div class="container">
		<span><a href="login.html" style="color:#059FBD;">LogIn/SignUp</a></span>
  ...
  <div class="container">
  <div class="row">
  <div class="col-md-12" style="text-align:center;margin-top:-100px;margin-bottom:50px;"><h2 class='logo-name'>Product details</h2></div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading"><?php echo $product_id.")  ".$product_name; ?></div>
        <div class="panel-body"><img src="<?php echo $product_image; ?>" class="img-responsive" style="width:100%;height:150px;" alt="Image"></div>
        <div class="panel-footer"><a href="cart.php?id=<?php echo $product_id;?>"><button type="button" class="btn btn-default btn-sm">
          <span class="fa fa-cart-plus btn btn-primary"></span> Add to Cart     <?php echo "Rs ".$product_price;?></div></a>
      </div>
    </div>
       <div class="col-sm-8 table-responsive table-bordered">
    ...
    <div class="footer-top">
      <div class="row">
        <div class="col-md-offset-3 col-md-6 text-center">
          <div class="widget">
            <h4 class="widget-title">The Gulam Sabir Restaurant</h4>
            ...
            <p class="copyright clear-float">
              &copy; Gulam Sabir Restaurant & Sweets Shop. All Rights Reserved
              <div class="credits">
